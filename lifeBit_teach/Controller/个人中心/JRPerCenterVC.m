...
-(void)updateSelfUi{
    ...
    self.nameLb.text = [HJUserManager shareInstance].user.pUserName;
    self.teleLb.text = [HJUserManager shareInstance].user.pMoble;
    self.classLb.text = [HJUserManager shareInstance].user.pUserName;
    self.identityLb.text = [HJUserManager shareInstance].user.pUserName;
    
    self.headImageView.layer.cornerRadius = self.headImageView.bounds.size.width/2;
    self.headImageView.layer.masksToBounds = YES;
    NSURL *url = [NSURL URLWithString:[HJUserManager shareInstance].user.pPic];
...
//            [HJUserManager shareInstance].user.pIco = [NSString stringWithFormat:@"%@%@",Image_BASE_URL,[NSString stringAwayFromNSNULL:[feedbackDic objectForKey:@"icon"]]];
