...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (isCunZai) {
        ...
        WatchModel *watchModel = [self.watchModelArr objectAtIndexWithSafety:index];
        LBWatchPerModel *watchPerModel = [self getPeripheralWithMac:watchModel.watchMAC];
